...
class octree
{
    static_assert(_Depth > 0, "octree template argument _Depth must greater than 0");
public:
...
private:
    ...
    const vec3<_BB_Unit> _minOctanLenSide;
    
    static constexpr _Contain _ctn{};
    static constexpr _ArbitraryPointGetter _apg{};
};
template <typename _Ele, typename _Contain, typename _ArbitraryPointGetter, typename _BB_Unit, const int _Depth>
constexpr _Contain octree<_Ele, _Contain, _ArbitraryPointGetter, _BB_Unit, _Depth>::_ctn;

template <typename _Ele, typename _Contain, typename _ArbitraryPointGetter, typename _BB_Unit, const int _Depth>
constexpr _ArbitraryPointGetter octree<_Ele, _Contain, _ArbitraryPointGetter, _BB_Unit, _Depth>::_apg;
